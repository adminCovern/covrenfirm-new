  ...
  const pricingTiers = [
    {
      ...
      ctaLink: "/sovereign-qualification?tier=proof",
      popular: false,
      availability: null
    },
    {
      ...
      ctaLink: "/sovereign-qualification?tier=proof-plus",
      popular: true,
      availability: 7,
    ...
    <ConsciousPage title="SOVREN AI - Sovereign Intelligence">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              The $4.7 Trillion Dependency Trap
            </h2>
            ...
            {[
              {
                ...
                stat: "$847K", 
                statLabel: "Average enterprise AI spend/year"
              },
              {
                ...
                stat: "100%",
                statLabel: "Of your data they keep"
              },
              {
                ...
                stat: "47min",
                statLabel: "Average downtime per month"
              }
            ].map((problem, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              },
              {
                ...
                title: "GH200 Strike Stack™",
                description: "4x NVIDIA GH200 Grace Hopper Superchips. Hardware supremacy others can't match.",
                capabilities: [
                  "288 ARM cores",
                  "1.92TB unified memory",
                  "576GB HBM3e",
                  "Zero bottlenecks"
                ]
              },
              ...
              },
              {
                ...
                description: "Deploy agent battalions that act without asking. Command intent, not tasks.",
                capabilities: [
                  "STRIKE battalion for sales",
                  "INTEL for data synthesis",
                  "OPS for workflows",
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                <p className="text-4xl font-black text-orange-400">47x</p>
                <p className="text-sm text-gray-400 mt-2">Faster Decisions</p>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                description: "SOVREN knows what you need before you ask. It predicts user actions with 94% accuracy.",
              ...
              },
              {
                ...
                description: "Mem0 architecture transcends token limits. Perfect recall across all interactions.",
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              The Sovereignty Revolution Has Begun
            </h2>
            <p className="text-xl text-gray-400">
              Join 2,847 businesses that chose ownership over rental
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            ...
            >
              <p className="text-5xl font-black text-cyan-400">$4.2M</p>
              <p className="text-gray-400 mt-2">Saved Monthly</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              ...
              className="text-center"
            >
              <p className="text-5xl font-black text-purple-400">94%</p>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <p className="text-5xl font-black text-green-400">340%</p>
              <p className="text-gray-400 mt-2">ROI Year 1</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
          ...
          >
            <p className="text-2xl text-white mb-4">
              "We went from $47K/month in AI costs to $797. But the real value? 
              We now own intelligence that compounds daily. Our AI gets smarter 
              while our competitors' bills get bigger."
            </p>
            <p className="text-gray-400">
              — Sarah Chen, CEO of TechFlow Industries
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-500 mt-8">
              No credit card required • 2-minute assessment • Instant results
            </p>
          </motion.div>
        </div>
      </section>
